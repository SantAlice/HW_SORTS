...
public class TicketTest {
    ...
    public void sortingTest() {
        ...
        Ticket[] expected = {ticket7, ticket5, ticket9};
    ...
    public void sortingTestComparatorNotExisting() {
        AviaSouls manager = new AviaSouls();
        Ticket ticket1 = new Ticket("MSK", "EKB", 210, 9, 13);
        Ticket ticket2 = new Ticket("NVS", "MSK", 320, 11, 14);
        Ticket ticket3 = new Ticket("NYK", "MSK", 510, 4, 10);
        ...
        Ticket[] actual = manager.search("AST", "NYK", comparator);
        Ticket[] expected = {};
    ...
    public void sortingTestComparatorBoundary() {
        AviaSouls manager = new AviaSouls();
        Ticket ticket1 = new Ticket("MSK", "EKB", 210, 9, 13);
        Ticket ticket2 = new Ticket("NVS", "MSK", 320, 11, 14);
        Ticket ticket3 = new Ticket("NYK", "MSK", 510, 4, 10);
        ...
        Ticket[] actual = manager.search("KRG", "SPB", comparator);
        Ticket[] expected = {ticket4};
